...
const TRANSLATIONS = {
  ko: {
    ...
    schedulerDesc: '서버가 계속 실행 중인 동안, 지정한 요일·시간에 N주 간격으로 자동으로 공고를 수집합니다.',
    schedulerEnabledLabel: '자동 수집 사용',
    timeLabel: '시간',
    dayMon: '월', dayTue: '화', dayWed: '수', dayThu: '목', dayFri: '금', daySat: '토', daySun: '일',
    intervalHoursLabel: '반복 주기(주)',
    schedulerKeyNote: '이 일정을 저장하면 그 시점부터 자동 수집은 저장한 계정 본인의 LLM API 키를 사용합니다 — 저장 전에 "회사 정보"에서 본인 키가 등록되어 있는지 확인하세요.',
    schedulerInUse: '사용 중',
  ...
  en: {
    ...
    schedulerDesc: 'While the server keeps running, notices are collected automatically on the selected weekday(s)/time, every N weeks.',
    ...
    intervalHoursLabel: 'Repeat every (weeks)',
    schedulerKeyNote: "Saving this schedule means automatic collection will use your own LLM API key from now on — make sure it's registered under \"Company Info\" before saving.",
